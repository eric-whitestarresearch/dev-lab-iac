output "iam_info" {
  value = {
    ...
    lf_goodnight_lambda_role = {
      name = aws_iam_role.lf_goodnight_lambda_role.name,
      arn = aws_iam_role.lf_goodnight_lambda_role.arn,
      id = aws_iam_role.lf_goodnight_lambda_role.id
    },
    lf_goodnight_eventbridge_role = {
      name = aws_iam_role.lf_goodnight_eventbridge_role.name,
      arn = aws_iam_role.lf_goodnight_eventbridge_role.arn,
      id = aws_iam_role.lf_goodnight_eventbridge_role.id
    },
  }
}
